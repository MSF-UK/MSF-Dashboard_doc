...
+ [ActivitiesMonitoring-Swaziland](http://braimbault.github.io/NA) - June 2016 (online, data parsed via ArcGIS online and KoBo)
...
MSF-Dashboard is copyright (c) 2016-present Bruno Raimbault <raimbault.bruno@gmail.com> and the [contributors to MSF-Dashboard](https://github.com/MSF-UK/MSF-Dashboard/graphs/contributors) for MSF UK.

MSF-Dashboard is free software, licensed under the MIT License. See the file `LICENSE.md` in this distribution for more details on the license and on dependencies.